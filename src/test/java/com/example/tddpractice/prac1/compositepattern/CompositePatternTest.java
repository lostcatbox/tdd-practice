...
public class CompositePatternTest {
    ...
    // 계좌(account)와 돈에 이동(transaction)을 조합하여,
    // 목적: 고객의 다수 전체 계좌에 대한 모든 남은 금액을 계산할수있을까??
    @Test
    ...
    @Test
    void 여러개의_계좌에서_50L_50L_50L에_대한_전체_잔액150L을_계산하기() {
        Transsaction transsactionplus100 = new Transsaction(100L);
        Transsaction transsactionminus50 = new Transsaction(-50L);
        ...
        accountC.addTrans(transsactionplus100);
        accountC.addTrans(transsactionminus50);

        accountA.addTrans(accountB);
        accountB.addTrans(accountC);

        Assertions.assertEquals(150L, accountA.balance());
    }
}
